...
public class MainFragmentBindingImpl extends MainFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.mf_srl, 1);
        sViewsWithIds.put(R.id.mf_rc, 2);
        sViewsWithIds.put(R.id.mf_img, 3);
        sViewsWithIds.put(R.id.mf_text_empty, 4);
        sViewsWithIds.put(R.id.mf_group, 5);
        sViewsWithIds.put(R.id.mf_fab, 6);
    }
    // views
    @NonNull
